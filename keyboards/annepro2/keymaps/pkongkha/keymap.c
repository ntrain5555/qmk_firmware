...
// Key symbols are based on QMK. Use them to remap your keyboard
 ...
 [_BASE] = LAYOUT_60_ansi(
    ...
    MO(_MAGIC),       KC_A,    KC_S,    KC_D, KC_F, KC_G, KC_H,   KC_J, KC_K, KC_L,    KC_SCLN, KC_QUOT,            KC_ENT,
    KC_LSFT,                   KC_Z,    KC_X, KC_C, KC_V, KC_B,   KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH,            RSFT_T(KC_UP),
    KC_LCTL,          KC_LALT, KC_LGUI,                   KC_SPC,                      KC_RGUI, LT(_CONF, KC_LEFT), RALT_T(KC_DOWN), RCTL_T(KC_RGHT)
),
 [_MAGIC] = LAYOUT_60_ansi(
/* |        ESC       |    1   |   2    |   3    |   4    |   5    |   6    |   7    |   8    |   9    |   0    |   -    |   +    |  BSPC  | */
    KC_GRV,            KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
    QK_MOUSE_BUTTON_3, KC_F13,  KC_VOLD, KC_VOLU, KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_CAPS, KC_NO,   KC_PSCR, KC_HOME, KC_END,  KC_NO,
    KC_NO,             KC_NO,   KC_NO,   KC_NO,  KC_NO,    KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PGUP, KC_PGDN, KC_NO,
